"""
Live signal checker — prints current margin ON/OFF status.
...
import signals.ma as ma_signal
...
def check(ticker: str):
    ...
    print(f"\n  Distance to cross: ${abs(distance):.2f} (fast MA needs to {direction} to cross)")
    print()
